...
function  car1_up(){
	if(car1_y >=0){
		ca1_y=car1_y -10;
		console.log("when up arrow is pressed, x=" + car1_x + "| y=" +car1);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function  car1_down(){
	if(car1_y <=500){
		ca1_y=car1_y + 10;
		console.log("when up down is pressed, x=" + car1_x + "| y=" +car1);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function  car1_left(){
	if(car1_y >=0){
		ca1_y=car1_y  10;
		console.log("when left arrow is pressed, x=" + car1_x + "| y=" +car1);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function  car1_right(){
	if(car1_y <=500){
		ca1_y=car1_y + 10;
		console.log("when right arrow is pressed, x=" + car1_x + "| y=" +car1);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
